import { AchievementId, TierTarget } from "../types";
...
interface AchievementDefinition {
  ...
  unit: string;
  tiers: TierTarget[];
  estimatedByDefault: boolean;
  badgeImageUrl: string;
}

function makeBadgeImage(
  text: string,
  accent: string,
  secondary: string,
): string {
...
> = {
  starstruck: {
    ...
    instructions:
      "Create useful public repositories and promote them to gain stars.",
    unit: "stars",
    tiers: [
  ...
  "pair-extraordinaire": {
    ...
    instructions:
      "Collaborate with another developer and use co-authored commits in a merged pull request.",
    unit: "merged PRs",
    tiers: [
  ...
  "galaxy-brain": {
    ...
    instructions:
      "Answer GitHub Discussions and get your answer marked as accepted.",
  ...
  "public-sponsor": {
    ...
    name: "Public Sponsor",
    description:
      "Sponsor an open source contributor or donate to JohnPaulZer through GitHub Sponsors.",
    instructions:
      "Publicly sponsor an open source contributor or donate to JohnPaulZer using GitHub Sponsors.",
    unit: "sponsorships",
    tiers: [{ label: "Default", target: 1 }],
