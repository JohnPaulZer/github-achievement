...
function AchievementSummary({ achievements }: AchievementSummaryProps) {
  ...
  return (
    <section className="w-full rounded-[1.45rem] border border-white/75 bg-white/72 px-5 py-4 shadow-[0_16px_36px_rgba(148,163,184,0.16)] backdrop-blur-xl sm:w-fit sm:min-w-96">
      <h2 className="text-base font-semibold text-slate-950">Achievements</h2>
          ...
          return (
            ...
            >
              <img
                ...
                className="h-14 w-14 rounded-full border-[3px] border-white bg-white object-cover shadow-[0_10px_22px_rgba(71,85,105,0.16)]"
              />
              {multiplier ? (
                <span className="absolute -bottom-1 -right-1 rounded-full bg-slate-950 px-2 py-0.5 text-[11px] font-bold leading-none text-white shadow-sm ring-2 ring-white">
                  {multiplier}
                </span>
              ) : null}
            </div>
