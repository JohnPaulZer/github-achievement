...
function TokenTutorialModal({ open, onClose }: TokenTutorialModalProps) {
  ...
  return createPortal(
    ...
    >
      <div
        className="scrollbar-invisible max-h-[min(720px,calc(100vh-3rem))] w-full max-w-2xl overflow-y-auto rounded-[1.35rem] border border-white/80 bg-white/95 p-5 text-slate-900 shadow-[0_26px_80px_rgba(71,85,105,0.24)] backdrop-blur-xl"
      ...
      >
        ...
        <div className="mt-5 grid gap-3">
          <section className="rounded-[1rem] border border-slate-200/70 bg-slate-50/80 p-4">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <a
                className="rounded-full bg-slate-950 px-4 py-2 text-xs font-semibold uppercase tracking-[0.12em] text-white transition hover:bg-slate-800"
              ...
              <a
                className="rounded-full border border-slate-200/80 bg-white px-4 py-2 text-xs font-semibold uppercase tracking-[0.12em] text-slate-700 transition hover:bg-slate-50"
                href={tokenDocsUrl}
                rel="noreferrer"
                target="_blank"
              >
          ...
          <section className="rounded-[1rem] border border-slate-200/70 bg-white/80 p-4">
            <h3 className="text-sm font-semibold text-slate-950">
              2. Use read-only permissions
            </h3>
            <div className="mt-3 grid gap-2 text-sm text-slate-600 sm:grid-cols-2">
              <p className="rounded-[0.85rem] bg-slate-50/90 px-3 py-2">
                Metadata: read
              </p>
              <p className="rounded-[0.85rem] bg-slate-50/90 px-3 py-2">
                Contents: read
          ...
          <section className="rounded-[1rem] border border-slate-200/70 bg-white/80 p-4">
            ...
            <a
              className="mt-3 inline-flex rounded-full border border-slate-200/80 bg-white px-4 py-2 text-xs font-semibold uppercase tracking-[0.12em] text-slate-700 transition hover:bg-slate-50"
